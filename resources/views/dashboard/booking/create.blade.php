  ...
  <div class="col-lg-8">
       <form method="POST" action="/dashboard/booking">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date') }}" required autofocus>
          @error('start_date')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ old('end_date') }}" required autofocus>
          @error('end_date')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
